  ...
  <div class="w-100">
    ...
    <div class="js-toggle-cart-totals full-width-container" style="display: none;">
      ...
      <div class="mt-4 mb-3"> 
        ...
        {{ component('price-without-taxes', {
            location: 'cart',
            container_classes: "row no-gutters mt-1",
            text_classes: {
                label: "col text-uppercase",
                price: "col text-right",
            },
          })
        }}
    ...
    <div class="container-fluid mt-3">
      ...
      {% if cart_page %}
        ...
        <input id="go-to-checkout" class="btn btn-primary btn-block mb-3" type="submit" name="go_to_checkout" {{ not should_show_checkout_button ? 'style="display:none"' }} value="{{ 'Iniciar Compra' | translate }}"/>
      ...
      {% else %}
        <div class="js-ajax-cart-submit row" {{ not should_show_checkout_button ? 'style="display:none"' }} id="ajax-cart-submit-div">
