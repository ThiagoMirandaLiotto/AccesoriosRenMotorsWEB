                ...
                <div class="swiper-slide slide-container">
                    ...
                    {% set has_text =  slide.title or slide.description or slide.button %}
                        <div class="slider-slide">
                            ...
                            {% else %}
                                {% set slide_thumb = use_smaller_thumbs ? 'large' : 'xlarge' %}
                                {% set slide_src = slide.image | static_url | settings_image_url(slide_thumb) %}
                            {% endif %}
                            ...
                            <img 
                                ...
                                class="slider-image {% if settings.slider_animation %}slider-image-animation{% endif %} {% if apply_lazy_load %}swiper-lazy fade-in{% endif %} {% if has_auto_height_slider %}position-relative d-block{% endif %}" 
