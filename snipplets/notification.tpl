...
{% if order_notification and status_page_url_notification %}
    <div class="js-notification js-notification-status-page notification notification-secondary notification-fixed-right notification-above col-auto ml-3" data-url="{{ status_page_url_notification }}" style="display:none;">
        <div class="container">
            <div class="row">
                <div class="col">
                    <a class="d-block mr-3" href="{{ status_page_url_notification }}"><span class="btn btn-link-underline">{{ "Seguí acá" | translate }}</span> {{ "tu última compra" | translate }}</a>
