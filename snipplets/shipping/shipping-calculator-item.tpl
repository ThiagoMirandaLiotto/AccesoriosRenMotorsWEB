        ...
        <span class="radio-button-content box">
            ...
            <div class="radio-button-label">
                ...
                <div class="radio-button-text"> 
                    {% if option.show_price %} 
                        <div class="h5 shipping-price mb-2">
                            ...
                            {% if option.cost.value == 0 and option.old_cost.value %}
                                <span class="price-compare ml-1 font-weight-normal">{{option.old_cost}}</span>
                            {% endif %}
                        </div>
                    {% endif %}
                    ...
                    {% if option.time %}
                        <div class="font-small {% if option.suboptions is not empty or option.payment_rules or (option.method == 'pickup-point' and option.pickup_hours is not empty) %}mb-1{% endif %}">
