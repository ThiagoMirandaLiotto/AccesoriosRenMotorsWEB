...
.form-select {
  ...
  &.form-select-small.open .form-select-icon {
    margin-top: 4px;
  }
}
...
.product-native-video-container .video-image {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
.product-native-video-container .embed-responsive {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
@media (max-width: 767px) {
  ...
  .product-native-video-container .dynamic-video-wrapper {
