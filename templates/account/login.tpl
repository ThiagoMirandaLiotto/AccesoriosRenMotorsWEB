...
<section class="account-page px-2 px-md-3">
    <div class="container-fluid">
        <div class="row">
            {# Account validation #}
            <div class="col-md-4 offset3 mt-3">
                {% if account_validation == 'success' %}
                    ...
                    <div class="js-account-validation-success alert alert-success">
                        <p class="mb-0">{{ success_message | tt }}</p>
                    </div>
        ...
        {% if 'mandatory' not in store.customer_accounts %}
            <p class="mt-3 text-center text-md-left mb-5 font-weight-light">{{ "¿No tenés cuenta aún?" | translate }} {{ "Crear cuenta" | translate | a_tag(store.customer_register_url, '', 'btn-link') }}</p>
        {% endif %}
    </div>
</section>